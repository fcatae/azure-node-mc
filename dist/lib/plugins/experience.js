...
var distanceToXpLevel = _require$experience.distanceToXpLevel;
var getXpLevel = _require$experience.getXpLevel;
var getBaseXpFromLevel = _require$experience.getBaseXpFromLevel;
...
module.exports.player = function (player) {
  ...
  player.setXp = function (xp) {
    ...
    var _ref$setLevel = _ref.setLevel;
    var setLevel = _ref$setLevel === undefined ? true : _ref$setLevel;
    var _ref$setDisplay = _ref.setDisplay;
    var setDisplay = _ref$setDisplay === undefined ? true : _ref$setDisplay;
    var _ref$send = _ref.send;
    var send = _ref$send === undefined ? true : _ref$send;
