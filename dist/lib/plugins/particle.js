...
module.exports.server = function (serv) {
  serv.emitParticle = function (particle, world, position) {
    ...
    var _ref$longDistance = _ref.longDistance;
    var longDistance = _ref$longDistance === undefined ? true : _ref$longDistance;
    var _ref$size = _ref.size;
    var size = _ref$size === undefined ? new Vec3(1, 1, 1) : _ref$size;
