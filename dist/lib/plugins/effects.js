...
module.exports.entity = function (entity, serv) {
  ...
  entity.sendEffect = function (effectId) {
    ...
    var _ref$amplifier = _ref.amplifier;
    var amplifier = _ref$amplifier === undefined ? 0 : _ref$amplifier;
    var _ref$duration = _ref.duration;
    var duration = _ref$duration === undefined ? 30 * 20 : _ref$duration;
    var _ref$particles = _ref.particles;
    var particles = _ref$particles === undefined ? true : _ref$particles;
    ...
    action: function action(params) {
      ...
      if (params[2] == 'clear') {
        targets.forEach(function (e) {
          return _Object$keys(e.effects).forEach(function (effectId) {
